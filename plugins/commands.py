...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("📌 Uᴘᴅᴀᴛᴇs", url="https://t.me/DnNetworkApp")
            ],[      
            InlineKeyboardButton("Hᴇʟᴩ 💡", callback_data="help"),
            InlineKeyboardButton("Aʙᴏᴜᴛ 📰", callback_data="about")
        ],[
        InlineKeyboardButton(" Make Your Own Bot", url="https://t.me/DNXtreme")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)   
        m=await message.reply_sticker("CAACAgUAAyEFAASm1XoWAAMJaJLprMRE58_bngyAzMhpKqIm7TwAAjYHAAIDu2BXzI9gRu_oupMeBA") 
...
async def shortlink(bot, message):
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\nGive me a shortener website link and api along with the command !\n\nFormat: <code>/shortlink .com aacda989a636df49b60ebd36dd5e82095eec1</code></b>")
